      ...
      <a className="border rounded-md p-6 group">
        ...
        <div className="mt-4 flex items-center justify-between space-x-2">
          ...
          <button
            ...
            className={`border rounded-lg py-1 px-4 hover:bg-blue-500 hover:border-blue-500 hover:text-white transition-colors disabled:opacity-50 disabled:cursor-not-allowed ${
              adding
                ? 'disabled:bg-blue-500 disabled:border-blue-500 disabled:text-white'
