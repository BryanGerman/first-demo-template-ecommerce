...
const addPayment = (state = {}, response = null) => {
  console.log("Llegué por aca")
...
const cartReducer = (state = {}, action) => {
  switch (action.type) {
    ...
    case 'CLEAR_CART':
      return clearCart();
    case 'ADD_PAYMENT':
      return addPayment(state, action.response);
    default:
      return state;
  }
};
...
export const useShoppingCart = () => {
  ...
  const addPayment = (response) => {
    console.log("HOOK!")
    return dispatch({ type: 'ADD_PAYMENT', response });
  }
